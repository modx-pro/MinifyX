...
$_lang['minifyx_prop_registerJs'] = 'How to register javascript? You can save it in the placeholder, call it in the tag "head" (startup) or place before the closing "body" (default).';
$_lang['minifyx_prop_registerCss'] = 'How to register CSS? You can save it in the placeholder or call in the tag "head" (default).';
